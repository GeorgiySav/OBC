...
namespace obc {
	namespace cuda {
		...
		extern void MatrixVecMul(const std::vector<double>& A, const size_t m, const size_t n, bool transpose, const std::vector<double>& x, std::vector<double>& y);
		...
		extern void VecVecElementwiseMul(const std::vector<double>& A, const std::vector<double>& B, std::vector<double>& C);
